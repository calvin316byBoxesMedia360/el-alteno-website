  ...
  return (
    <div className="group break-inside-avoid mb-6">
      <div className="flex items-baseline gap-2">
        ...
        />
        <span className="text-mustard font-extrabold text-sm md:text-base shrink-0 tabular-nums">
          ${item.price.toFixed(2)}
        </span>
      </div>

      <p className="text-muted-foreground text-xs leading-relaxed mt-1 pr-16">
